...
import project.gdsc.zealicon22.utils.MANAGEMENT

/**
 * @Author: Karan Verma
 * @Date: 08/04/22
 */
class ManagementTeamAdapter(private val teamList: ArrayList<TeamsModalItem>) :
    RecyclerView.Adapter<ManagementTeamAdapter.VH>() {
